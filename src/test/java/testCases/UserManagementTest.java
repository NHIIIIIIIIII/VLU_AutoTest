...
public class UserManagementTest extends BaseTest {
    ...
    public void testUserCreationScenarios(String id, String name, String email, String contract, String role) throws InterruptedException {
        ...
        // TC_CU_02: Kiểm tra hệ thống báo lỗi khi nhập email không hợp lệ
            ...
            // Kiểm tra nội dung lỗi hiển thị trong phần tử cụ thể
            String errorXpath = "/html[1]/body[1]/div[3]/div[2]/form[1]/div[3]/label[2]";
            String actualErrorMessage = driver.findElement(By.xpath(errorXpath)).getText();
            String expectedErrorMessage = "Vui lòng nhập email Văn Lang hợp lệ!";

            if (actualErrorMessage.equals(expectedErrorMessage)) {
                System.out.println("✅ TC_CU_02: Test thành công - Hệ thống báo đúng lỗi: '" + expectedErrorMessage + "'.");
            } else {
                System.out.println("❌ TC_CU_02: Test thất bại - Lỗi hiển thị không đúng. Nhận được: '" + actualErrorMessage + "'");
            }
